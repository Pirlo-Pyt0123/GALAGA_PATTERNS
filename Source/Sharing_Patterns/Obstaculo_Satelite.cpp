...
AObstaculo_Satelite::AObstaculo_Satelite()
{
...
void AObstaculo_Satelite::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AObstaculo_Satelite::NotifyActorBeginOverlap(AActor* OtherActor)
{
...
void AObstaculo_Satelite::Componente_Destruccion()
{
