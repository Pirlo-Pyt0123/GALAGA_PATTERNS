...
AObstaculo_Asteroide::AObstaculo_Asteroide()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh>MeshAsset(TEXT("StaticMesh'/Game/Malla_Obstaculos/Obstaculos_02/OBSTCULOS_02.OBSTCULOS_02'"));
...
void AObstaculo_Asteroide::Tick(float DeltaTime)
{
		Super::Tick(DeltaTime);

}

void AObstaculo_Asteroide::NotifyActorBeginOverlap(AActor* OtherActor)
{
...
void AObstaculo_Asteroide::Componente_Destruccion()
{
